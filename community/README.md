...
We’re all in this together. There are new capabilities included in the latest Phoenix version (3.2+) of BTC69coin that open up new business opportunities.  Join in and build something.  This is not an exhaustive list, but just a starting point to fire the imagination.  
...
* Core
    * Asset Exchange Proxy (simulate sending an ASSET like btc69d does for BTC69)
...
* Run a contest: BTC69 prize for best idea for new BTC69coin based Business
...
* Back-end API platform for BTC69coin
    * Other people to hit high-availablity API
* Fee system to pay BTC69 fees automatically
    * Auto-pay fees
    * Can take X% of fees
...
* Auto fee funder (so users of ABC token doesn’t need to worry about fees)
    ...
    * Sends small amount of BTC69 for fees.
...
* #KYC tagger - store info and tag BTC69coin addresses
* #ACCREDITED - verify accredited status and tag BTC69coin addresses
 
### Technical Consultant
* Help companies apply BTC69coin capabilities to real-world problems
* Security Token Issuance Platform
* Collaborate with exchanges for more listings
* Collaborate with custodial Security Token exchanges for deposit/withdrawal
* Collaborate with hardware wallets for additional BTC69 and asset support


### Areas for BTC69coin Innovation
* Financial
