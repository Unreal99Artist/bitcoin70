## Please read https://github.com/JustAResearcher/Bitcoin69/blob/master/doc/build-windows.md
...
# Pick some path to install BDB to, here we create a directory within the Bitcoin69 directory
