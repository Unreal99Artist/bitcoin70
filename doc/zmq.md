...
The BTC69 Core daemon can be configured to act as a trusted "border
router", implementing the btc69 wire protocol and relay, making
...
The ZeroMQ feature in BTC69 Core requires the ZeroMQ API >= 4.0.0
...
during the *configure* step of building btc69d:
...
For instance:
    ...
    $ btc69d -zmqpubhashtx=tcp://127.0.0.1:28766 \
               -zmqpubrawtx=ipc:///tmp/btc69d.tx.raw
...
These options can also be provided in btc69.conf.
...
From the perspective of btc69d, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into btc69d directly. Furthermore, no information is
...
using. BTC69d appends an up-counting sequence number to each
