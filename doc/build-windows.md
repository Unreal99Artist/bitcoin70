...
Below are some notes on how to build BTC69 Core for Windows.
...
way. This will install to `c:\workspace\btc69`, for example:

    make install DESTDIR=/mnt/c/workspace/btc69
