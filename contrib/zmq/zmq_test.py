...
"""
    ...
    Bitcoin69 should be started with the command line arguments:
        btc69d -testnet -daemon \
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND btc69 issuance at " + str(pos))
				print("After btc69: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND btc69 something at " + str(pos))
			start += pos+8
			print(astr)
