...
# TestNode: A peer we use to send messages to btc69d, and store responses.
...
class CompactBlocksTest(Bitcoin69TestFramework):
    ...
    # This test actually causes btc69d to (reasonably!) disconnect us, so do this last.
    ...
    # Test that btc69d requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for btc69d to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # btc69d will not send blocktxn responses for blocks whose height is
