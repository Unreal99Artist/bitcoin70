...
import os
import struct
from test_framework.test_framework import Bitcoin69TestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(Bitcoin69TestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that btc69 has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("btc69d has not been built with zmq enabled.")
