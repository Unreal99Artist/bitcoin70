...
class RawTransactionsTest(Bitcoin69TestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "changeAddress must be a valid btc69 address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
