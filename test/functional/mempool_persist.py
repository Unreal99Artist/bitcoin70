...
By default, btc69d will dump mempool on shutdown and
...
class MempoolPersistTest(Bitcoin69TestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give btc69d a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent btc69d from writing mempool.dat to disk. Verify that `savemempool` fails")
