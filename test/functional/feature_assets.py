...
class AssetTest(Bitcoin69TestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("BTC691", 1000)
        n0.issue("BTC692", 1000)
        n0.issue("BTC693", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="BTC69*", verbose=False, count=2, start=-2)
        ...
        btc69_assets = n0.listassets(asset="BTC69*", verbose=False, count=2, start=-2)
        assert_equal(len(btc69_assets), 2)
        assert_equal(btc69_assets[0], "BTC692")
        assert_equal(btc69_assets[1], "BTC693")
        self.sync_all()
