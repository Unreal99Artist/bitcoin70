...
class TestBitcoin69Cli(Bitcoin69TestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `btc69-cli getinfo`")
        ...
        self.log.info("Compare responses from `btc69-cli -getinfo` and the RPCs data is retrieved from.")
