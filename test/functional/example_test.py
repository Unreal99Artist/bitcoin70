...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the Bitcoin69TestFramework
    pass

class ExampleTest(Bitcoin69TestFramework):
    # Each functional test is a subclass of the Bitcoin69TestFramework class.
    ...
    def custom_method(self):
        ...
        Bitcoin69TestFramework class so other tests can use it."""
