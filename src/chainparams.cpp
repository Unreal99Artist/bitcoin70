...
// Copyright (c) 2022-2023 BTC69 developers
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 14400; 
	    ...
	    consensus.BIP34LockedIn = 0; // Locked_in at height 0
	    ...
	    uint32_t nGenesisTime = 1688352006; // 
        ...
        // New dnsseeder
        vSeeds.emplace_back("1.btc69.org", false);
        vSeeds.emplace_back("2.btc69.org", false);
	vSeeds.emplace_back("69.btc69.org", false);


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,0);  //  prefix
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5);  //  prefix
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // BTC69 BIP44 cointype in mainnet is '0'
        nExtCoinType = 0;
		...
		checkpointData = (CCheckpointData) {
            {
            	{
            	    {0, uint256S("0x00bd50f71948c0d163fe0beafc87afaff6ccd27da67c409cdd111e63840e23d4")},
                    {100, uint256S("0x00b3d9b4366bd61d7486e6a24345cb7755b1ede37f716d3373a33f013e35e408")},
            	}
            }
        };
        ...
        chainTxData = ChainTxData{
        	...
        	1706539169, // * UNIX timestamp of last known number of transactions
        ...
        // 5% of 500 BTC69 to operations wallet
	    nCommunityAutonomousAmount = 5;
        // Operations wallet placeholder

        // Burn Addresses
	    strIssueAssetBurnAddress = "1issueAssetXXXXXXXXXXXXXXXXXhhZGt";
        strReissueAssetBurnAddress = "1ReissueAssetXXXXXXXXXXXXXXVEFAWu";
        strIssueSubAssetBurnAddress = "1issueSubAssetXXXXXXXXXXXXXWcwhwL";
        strIssueUniqueAssetBurnAddress = "1issueUniqueAssetXXXXXXXXXXWEAe58";
        strIssueMsgChannelAssetBurnAddress = "1issueMsgChanneLAssetXXXXXXSjHvAY";
        strIssueQualifierAssetBurnAddress = "1issueQuaLifierXXXXXXXXXXXXUgEDbC";
        strIssueSubQualifierAssetBurnAddress = "1issueSubQuaLifierXXXXXXXXXVTzvv5";
        strIssueRestrictedAssetBurnAddress = "1issueRestrictedXXXXXXXXXXXXzJZ1q";
        strAddNullQualifierTagBurnAddress = "1addTagBurnXXXXXXXXXXXXXXXXZQm5ya";

        
        //Global Burn Address
        strGlobalBurnAddress = "1BurnXXXXXXXXXXXXXXXXXXXXXXWUo9FV";

        // BTC69 Operations Fund
        strCommunityAutonomousAddress = "1F8USuivqtejhmPXP1iAXWkqjfTe5mXo61";
...
*/
        ...
        vSeeds.emplace_back("seed1-testnet.btc69.org", false);
        vSeeds.emplace_back("seed2-testnet.btc69.org", false);
        ...
        // BTC69 BIP44 cointype in testnet
        nExtCoinType = 1;
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the BTC69 chain
	    ...
	    // 5% of 500 BTC69 to operations fund
	    nCommunityAutonomousAmount = 5;
...
*/
        ...
        // BTC69 BIP44 cointype in regtest
        nExtCoinType = 1;
