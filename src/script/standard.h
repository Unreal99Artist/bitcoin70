...
#ifndef BTC69_SCRIPT_STANDARD_H
#define BTC69_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_BTC69_ASSET script that carries data
    /** BTC69 END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a btc69 address
 */
...
/**
 * Generate a Bitcoin69 scriptPubKey for the given CTxDestination. Returns a P2PKH
