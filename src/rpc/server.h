...
#ifndef BTC69_RPCSERVER_H
#define BTC69_RPCSERVER_H
...
/**
 * Bitcoin69 RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern CAmount AmountFromValue(const UniValue& value, bool p_isbtc69 = true);
