...
CAmount AmountFromValue(const UniValue& value, bool p_isbtc69)
{
    ...
    if (p_isbtc69 && !MoneyRange(amount))
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "Bitcoin69 server stopping";
}
...
{
    return "> btc69-cli " + methodname + " " + args + "\n";
}
