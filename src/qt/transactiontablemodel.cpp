...
//{
//    columns[Amount] = Bitcoin69Units::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed, Bitcoin69Units::SeparatorStyle separators) const
{
    QString str;
    switch(wtx->type) {
        case TransactionRecord::Issue:
        ...
        default:
            {
            str = Bitcoin69Units::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->credit + wtx->debit,
                                             false, separators);
            } break;
    }
    if (showUnconfirmed) {
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DisplayRole:
        ...
        case Amount:
            return formatTxAmount(rec, true, Bitcoin69Units::separatorAlways);
        case AssetName:
            if (rec->assetName != "btc69")
               return QString::fromStdString(rec->assetName);
            else
               return QString(Bitcoin69Units::name(walletModel->getOptionsModel()->getDisplayUnit()));
        }
        break;
    case Qt::EditRole:
    ...
    case TxPlainTextRole:
        {
            ...
            details.append(formatTxAmount(rec, false, Bitcoin69Units::separatorNever));
            return details;
        }
    case ConfirmedRole:
    ...
    case FormattedAmountRole:
        ...
        return formatTxAmount(rec, false, Bitcoin69Units::separatorNever);
    case AssetNameRole:
        {
            QString assetName;
            if (rec->assetName != "btc69")
               ...
               assetName.append(QString(Bitcoin69Units::name(walletModel->getOptionsModel()->getDisplayUnit())));
            return assetName;
        }
    case StatusRole:
...
QVariant TransactionTableModel::headerData(int section, Qt::Orientation orientation, int role) const
{
    if(orientation == Qt::Horizontal)
    {
        ...
        } else if (role == Qt::ToolTipRole)
        {
            ...
            case AssetName:
                return tr("The asset (or btc69) removed or added to balance.");
            }
        }
    }
    return QVariant();
