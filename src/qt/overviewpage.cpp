...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(Bitcoin69Units::btc69),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->btc69BalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->btc69BalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(Bitcoin69Units::formatWithUnit(unit, balance, false, Bitcoin69Units::separatorAlways));
    ui->labelUnconfirmed->setText(Bitcoin69Units::formatWithUnit(unit, unconfirmedBalance, false, Bitcoin69Units::separatorAlways));
    ui->labelImmature->setText(Bitcoin69Units::formatWithUnit(unit, immatureBalance, false, Bitcoin69Units::separatorAlways));
    ui->labelTotal->setText(Bitcoin69Units::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, Bitcoin69Units::separatorAlways));
    ui->labelWatchAvailable->setText(Bitcoin69Units::formatWithUnit(unit, watchOnlyBalance, false, Bitcoin69Units::separatorAlways));
    ui->labelWatchPending->setText(Bitcoin69Units::formatWithUnit(unit, watchUnconfBalance, false, Bitcoin69Units::separatorAlways));
    ui->labelWatchImmature->setText(Bitcoin69Units::formatWithUnit(unit, watchImmatureBalance, false, Bitcoin69Units::separatorAlways));
    ui->labelWatchTotal->setText(Bitcoin69Units::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, Bitcoin69Units::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("btc69")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the btc69 balance grid from expanding and looking terrible when asset balance is hidden
