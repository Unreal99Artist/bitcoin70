...
#ifndef BTC69_QT_GUIUTIL_H
#define BTC69_QT_GUIUTIL_H
...
/** Utility functions used by the btc69 Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "btc69:" URI into recipient object, return true on successful parsing
