...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<Bitcoin69AmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_btc69-qt -platform xcb      # Linux
//     src/qt/test/test_btc69-qt -platform windows  # Windows
//     src/qt/test/test_btc69-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = Bitcoin69Units::formatWithUnit(unit, balance, false, Bitcoin69Units::separatorAlways);
    ...
    // Amount input
    Bitcoin69AmountField* amountInput = receiveCoinsDialog.findChild<Bitcoin69AmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: btc69:")) != -1);
