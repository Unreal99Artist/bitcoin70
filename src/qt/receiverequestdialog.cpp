...
#include "config/btc69-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatBitcoin69URI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + Bitcoin69Units::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatBitcoin69URI(info));
}
