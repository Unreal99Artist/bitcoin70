...
#ifndef BTC69_QT_Bitcoin69GUI_H
#define BTC69_QT_Bitcoin69GUI_H
...
/**
  btc69 GUI main class. This class represents the main window of the btc69 UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class Bitcoin69GUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit Bitcoin69GUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~Bitcoin69GUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a btc69 wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
