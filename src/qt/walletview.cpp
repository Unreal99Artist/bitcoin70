...
void WalletView::setBitcoin69GUI(Bitcoin69GUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? Bitcoin69GUI::HD44_ENABLED : _walletModel->hdEnabled() ? Bitcoin69GUI::HD_ENABLED : Bitcoin69GUI::HD_DISABLED);
