...
#ifndef BTC69_QT_OPTIONSMODEL_H
#define BTC69_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for btc69 client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // Bitcoin69Units::Unit
