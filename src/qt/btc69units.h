...
#ifndef BTC69_QT_BTC69UNITS_H
#define BTC69_QT_BTC69UNITS_H
...
/** btc69 unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class Bitcoin69Units: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit Bitcoin69Units(QObject *parent);
...
typedef Bitcoin69Units::Unit Bitcoin69Unit;

#endif // BTC69_QT_BTC69UNITS_H
