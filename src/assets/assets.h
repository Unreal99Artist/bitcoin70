...
#ifndef BTC69COIN_ASSET_PROTOCOL_H
#define BTC69COIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_BTC69_ASSET btc69Q (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_BTC69_ASSET btc69O
bool CheckReissueDataTx(const CTxOut& txOut);// OP_BTC69_ASSET btc69R
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_BTC69_ASSET btc69T
...
#endif //BTC69COIN_ASSET_PROTOCOL_H
