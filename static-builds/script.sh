...
find ${DISTNAME}/bin -type f -executable -exec ../Bitcoin69/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../Bitcoin69/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
cd ~/
rm -rf win64
cp -rf Bitcoin69/contrib/windeploy ~/sign/win64
cd ~/sign/win64/windeploy
mkdir -p unsigned
mv ~/Bitcoin69/btc69-*setup-unsigned.exe unsigned/
...
cd ~/
rm -rf win32
cp -rf Bitcoin69/contrib/windeploy ~/sign/win32
...
mkdir -p ~/Bitcoin69/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/Bitcoin69/depends/SDKs/MacOSX10.11.sdk.tar.gz
cd ~/Bitcoin69/depends/SDKs && tar -xf MacOSX10.11.sdk.tar.gz 
