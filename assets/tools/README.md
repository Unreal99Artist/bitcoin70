...
### IPFS Pinner
Loops through blocks and transactions and pins asset issuance meta-data and then monitors btc69d transactions for new ipfs metadata via zmq.
...
* Run btc69d or btc69-qt with parameter to use zmq: ```-zmqpubrawtx=tcp://127.0.0.1:28766```
